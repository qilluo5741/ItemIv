...
public interface PermissionMapper {
	...
	//根据角色查询没有拥有的菜单 -->
	public List<MenusDto>  getNotExistsMenusByRoleId(@Param("roleId")String roleId);
	//查询菜单是否能够分配
	...
	//创建用户
	public int createUser(@Param("userPassword")String userPassword,@Param("user")UserInfo user);
	//验证用户账号是否已经存在
