	...
	$(function(){
		...
		$.confirm=function(obj){
			...
			if(val==""){
				...
				//执行修改
				$.ajax({
					url:'permission/updateRoleName.do',
		...
		$(".manager_").bind("click",function(){
			window.location.href="permission/RoleMenuView.do?roleId="+$(this).attr("id");
		})
	});
</script>
<!-- 模态框（Modal） -->
